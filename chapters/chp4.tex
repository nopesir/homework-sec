...
% ------ CHAPTER INTRO ------
In this last chapter are presented some important best practices along with a deep analysis of the common attacks on \textit{\oauth}. All the risks linked to the protocol are described in the Section 10 of the \rfc{6749} \cite{RFC6749}.
...
How is this relevant all of this to an \oauth\ client application? 
