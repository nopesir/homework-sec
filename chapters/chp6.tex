...
\noindent That is the base React application to build on. We have to populate and organize the final directory structure in order to look like in figure \ref{fig:dirtree}.
